...
const project = projects.map((projects) =>
    <div className="card col-sm-6" key={projects.key}>
        <img src="" className="card-img-top placeholder" alt="..."></img>
        <div className="card-body">
            <h5 className="card-title"> {projects.pname} </h5>
            <p className="card-text"> {projects.details} </p>
            <a href="Projects" className="btn btn-primary"> {projects.link} </a>
        </div>
    </div>
);
